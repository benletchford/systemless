...
for (const asset of ['/emulator-worker.js', '/renderer-worker.js', '/renderer-transport.js', '/renderer-client.js', '/renderer-gpu.js', '/renderer-owner.js', '/snippets/systemless-org-hash/inline0.js']) {
