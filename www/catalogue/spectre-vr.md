...
kind: game
title: Spectre VR
summary: Enter Velocity's first-person tank arena in the original Spectre VR CD Demo.
...
compatibility:
  ...
  - date: "2026-09-23"
    ...
    architecture: 68k
    environment: >-
      Deterministic run from the unchanged Spectre VR Demo StuffIt archive, through
      the launcher and vehicle selection into a live Level 1 scene
    status: boots
...
- id: archive
  ...
  source:
    type: sha256
    sha256: a915af0974f0e99dbc01e462e3e5471c42cf817cfc6f9f13bd811b3f9e958dbb
    size_bytes: 23339583
  provenance:
    ...
    permission: >-
      ...
      included read-me identifies it as a demo and distinguishes it from the retail game.
      Classic Macintosh Game Demos documents period demo-disc distribution and continues
      to offer the demo archive. Only the original promotional demo is staged, not the
      retail game.
    notes: >-
      Unchanged 23,339,583-byte StuffIt archive with SHA-256
      a915af0974f0e99dbc01e462e3e5471c42cf817cfc6f9f13bd811b3f9e958dbb. It contains the 68K Spectre VR CD Demo
      application and its bundled data.
- id: gameplay-screenshot
  role: screenshot
  format: png
  source:
    type: sha256
    sha256: bfc966663c63663a2073b5f38a737edaf243eeadf1250f390031a95712e694fd
    size_bytes: 46047
  provenance:
    redistribution: permitted
    original: true
    ...
    permission: >-
      ...
      request. Underlying Spectre VR artwork remains the property of its rights holders.
    notes: >-
      Fresh deterministic Systemless 0.51.0 capture from the staged demo on
      2026-09-23, after selecting a vehicle and entering Level 1. The 800x600 guest framebuffer
      was captured as the 512x342 game viewport. PNG SHA-256
      bfc966663c63663a2073b5f38a737edaf243eeadf1250f390031a95712e694fd; 46,047 bytes. The custom launcher control
      artwork is not yet rendered correctly in Systemless; see the compatibility
      evidence.
references:
- https://classicmacdemos.com/spectre-vr
- https://static.classicmacdemos.com/demos/spectre-vr/README.txt
...
![Spectre VR CD Demo Level 1 tank view](https://assets.systemless.org/catalogue/media/sha256/bf/bfc966663c63663a2073b5f38a737edaf243eeadf1250f390031a95712e694fd.png)
