...
title: MacAttack
summary: >-
  Battle through rendered corridors in New Reality Entertainment's three-level
  shareware demo.
...
- id: archive
  ...
  provenance:
    ...
    permission: >-
      The included ReadMe permits complete, unmodified, non-profit distribution
      without prior notice and specifically invites uploads to bulletin boards. Distribution
      for profit or on physical media requires written permission.
    notes: >-
      Unchanged 848,461-byte demo archive from Classic Mac Demos, SHA-256
...
- id: gameplay-screenshot
  ...
  source:
    type: sha256
    sha256: cedf6f5fc5ade12603605df36bd70fb2959b2eac8de6098fc5a1a72eced8846b
    size_bytes: 31337
  provenance:
    redistribution: permitted
    content_only: true
    ...
    permission: >-
      ...
      catalogue entry. Underlying game artwork remains the property of New Reality
      Entertainment, Inc.
    notes: >-
      Fresh deterministic Systemless capture after entering the live 3D playfield,
      moving the aim and using the smart bomb. The 800x600 framebuffer was cropped to the
      800x580 game surface below the Classic Mac menu bar; no host UI, emulator
      chrome, menu-only screen, or title-only frame remains. PNG SHA-256
      cedf6f5fc5ade12603605df36bd70fb2959b2eac8de6098fc5a1a72eced8846b, 31,337 bytes.
references:
- https://classicmacdemos.com/macattack
...
![MacAttack gameplay](https://assets.systemless.org/catalogue/media/sha256/ce/cedf6f5fc5ade12603605df36bd70fb2959b2eac8de6098fc5a1a72eced8846b.png)
