...
compatibility:
  ...
  - date: "2026-09-25"
    ...
    environment: >-
      ...
      the Explorer introduction, scenario selector, and Earth map. The selector
      and Explorer help text have a known graphical divergence from BasiliskII.
    status: boots
    evidence: https://github.com/benletchford/systemless/issues/2560
artifacts:
- id: archive
  role: archive
  format: sit
...
- https://macintoshgarden.org/games/simearth
- https://www.macintoshrepository.org/19424-the-macintosh-demo-games-cd
- https://github.com/benletchford/systemless/issues/2560
---
...
and a selectable Earth scenario. It is a limited overview rather than the
retail simulation.

This entry preserves the original demo archive without registration material
or a repack. Systemless reaches the Earth map, but the scenario selector and
Explorer help text still render differently from BasiliskII. The mismatch is
tracked in [issue #2560](https://github.com/benletchford/systemless/issues/2560),
and browser launch remains disabled until it is fixed and approved.
