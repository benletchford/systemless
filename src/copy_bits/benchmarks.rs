...
fn measure_indexed_shrink_full_operation() {
    ...
    for (width, height) in [(64usize, 64usize), (640, 480), (2048, 2048)] {
        ...
        for presentation in [false, true] {
            ...
            println!("{{\"kernel\":\"indexed8_horizontal_shrink\",\"width\":{width},\"height\":{height},\"presentation\":{presentation},\"samples\":31,\"full_median_ns\":{},\"pure_median_ns\":{}}}", median_ns(full), median_ns(kernel));
        }
    }
}
